...
export const abilityKeywords: AbilityKeyword[] = [
  ...
  {
    name: "屏障碰撞",
    name_en: "Barrier Collide",
    description: "会与屏障碰撞，但此攻击施加的伤害和效果可贯穿屏障和英雄",
  },
  {
    name: "摧毁屏障",
    name_en: "Destroy Barrier",
  ...
  {
    name: "暴击免疫",
    name_en: "Critical Immune",
    description: "无视命中暴击部位的攻击造成的额外伤害。对技能暴击无效",
  },
  {
    name: "无视近身攻击",
    name_en: "Ignore Melee",
